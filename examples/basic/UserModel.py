...
class UserModel(Model.ScheduledModel):
	def __init__(self):
		...
		#self.insert_state(name, resource_consumption_fn, atp_production_fn, enzyme_production_fn, enzyme_consumption_fn, division_age, min_atp_req_to_divide, no_of_div_before_death)
