...
class ScheduledModel():
	def __init__(self):
		...
		self.set_resource_production_fn = None

	def insert_state(self, state, resource_consumption_fn, atp_production_fn, division_age, min_food_req_to_divide, no_of_div_before_death):
